...
**NOTE:** As with any other account mentioned in this listing, the governance account is a PDA account that's seeded with the realm account address
...
**NOTE:** On creating a proposal, there is a deposit.
